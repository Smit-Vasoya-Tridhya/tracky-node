...
class PitchService {
  promptMaker = (payload, name) => {
    try {
      const system_role = {
        role: "system",
        content: `Immerse yourself in the ${payload?.selected_role} of a skilled sales professional and deliver a compelling pitch. Stay in character throughout the interaction. After each full stop, please add a newline character (\n).`,
      };
